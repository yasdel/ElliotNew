    ...
    def train(self):
        ...
        for it in range(self._epochs):
            ...
            if not (it + 1) % self._validation_rate:
                ...
                with open('results/AML_Lyp/AML_RecSys_Lyapanov_ML_100k_allepochs_allgamma' + '.csv',
                          'a') as f1:
                ...
                if it+1 == self._epochs:
                    ...
                    with open('results/AML_Lyp/AML_RecSys_Lyapanov_ML_100k_finalepoch_allgamma' +'.csv', 'a') as f1:
                        writer = csv.writer(f1, delimiter=',', lineterminator='\n')
                        writer.writerow(rows)
