    ...
    def train(self):
        ...
        for it in range(self._epochs):
            ...
            if not (it + 1) % self._validation_rate:
                ...
                if (it + 1) % 5 == 0:
                    with open('results/AML_Lyp/BPR_Lyapanov_'+ 'AmazonDigMusic' + '_every_five_epoch' + '.csv',
                              'a') as f1:
                ...
                if it+1 == self._epochs:
                    ...
                    with open('results/AML_Lyp/BPR_RecSys_Lyapanov_' + 'AmazonDigMusic'  + '_finalepoch' +'.csv', 'a') as f1:
                        writer = csv.writer(f1, delimiter=',', lineterminator='\n')
                        writer.writerow(rows)
